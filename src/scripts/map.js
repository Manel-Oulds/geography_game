class Map {
    ...
    fetch("./assets/world.svg")
      ...
      .then((svgData) => {
        ...
        countries.forEach((country) => {
          fetch(
            `https://restcountries.com/v3.1/name/${country.id}?fullText=true`
          )
            .then((res) => res.json())
          ...
          country.addEventListener("mouseover", function () {
            ...
            fetch(
              ...
              .then((data) => {
                ...
                var languages = (flag.innerText = `Common Name: ${
                  data[0].name.common
                }  \n  Official Name: ${data[0].name.official}   \n  Capital: ${
                  data[0].capital[0]
                }\n   Continent: ${
                  data[0].continents
                }\n Language: ${Object.values(
                  data[0].languages
  ...
  displayHome() {
    ...
    worldButton.addEventListener("click", () => {
      ...
      if (document.getElementsByClassName("main_buttons")[0])
