...
class Africa {
  ...
  startTimer() {
    ...
    let div_timer = `<img style="width:50px; height:50px; " src="${process.env.BASE_URL}/assets/timer.png"/> <p style="border: 2px solide white"> ${this.seconds} </p>`;
    ...
    let timerId = setInterval(() => {
      if (this.seconds === 0) {
        ...
        this.seconds--;
        let div_timer = `<img style="width:50px; height:50px; " src="${process.env.BASE_URL}/assets/timer.png"/> <p> ${this.seconds} </p>`;
        // timer.innerHTML = `<img style="width:50px; height:50px; padding: 5px" src="../assets/timer.png"/> ${this.seconds}`;
        timer.innerHTML = div_timer;
      }
